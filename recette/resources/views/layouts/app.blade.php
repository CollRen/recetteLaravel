            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarsExample03">
                    <ul class="navbar-nav me-auto mb-2 mb-sm-0">
                        @auth
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="{{ route('recette.index') }}">@lang('Recettes')</a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown"
                                aria-expanded="false">@lang('Recettes')</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('recette.create') }}">@lang('New Recette')</a></li>
                                <li><a class="dropdown-item" href="{{route('recette.completed', 1)}}">@lang('Completed')</a></li>
                                <li><a class="dropdown-item" href="{{route('recette.completed', 0)}}">@lang('Unfinished')</a></li>
                            </ul>
                        </li>
                        @endauth
                    </ul>
